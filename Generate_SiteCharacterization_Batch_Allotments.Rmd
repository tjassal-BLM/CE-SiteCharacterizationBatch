---
title: "Site Characterization Batch Reports - WY Allotments"
...
Download Site Characterization reports in **batch mode** by looping over allotments in a local shapefile and hitting the Climate Engine API.

```{r generate_links}
# -------------------------- Generate report links for WY allotments -------------------------------------

# Read allotment polygons and transform to WGS84 lon/lat for API coordinates
allotments_path <- "SourceData/WY-test-allotments-wdummy/WY-test-allotments.shp"
...
download_dir <- "Reports_Out_AllLand/"
